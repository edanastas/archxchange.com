...
/*
if ( eregi("/home/havecigs/public_html", $_SERVER[SCRIPT_FILENAME]) ) { ////////// DEVELOPMENT COMPUTER
	include(TEMPLATE_BASE_DIR . "../secure/config_smokes.php");
} elseif ( eregi("/Library/WebServer/Documents", $_SERVER[DOCUMENT_ROOT]) ) { ////////// DEVELOPMENT COMPUTER
