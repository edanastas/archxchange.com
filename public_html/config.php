...
// GLOBAL // 
//define('LOCAL', ( eregi("^(concord.local|192\.168\.)",$_SERVER[HTTP_HOST]) ? TRUE : FALSE )); // LOCAL DEV SERVER
...
$secure_path = (LOCAL ? dirname(__FILE__) . "/../secure/" : "/www/wwwroot/secure/archxchange/");
