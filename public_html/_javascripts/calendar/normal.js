...
var gsNavPrev="<b id='navPrev' class='MonthNav' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>&#171</b>";	// the content of the left month navigator
...
var gsNavNext="<b id='navNext' class='MonthNav' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>&#187</b>";	// the content of the right month navigator
...
var gcOtherDay="#777";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
...
var gcBGSelected="#DB5141";	// the background color for the selected date // default changed DB5141
var guSelectedBGImg="";	// url of image as background of the selected date
var giMarkSelected=9;	// Effects for selected date - 0: nothing; 1: set background color with gcBGSelected; 2: draw a box with gcBGSelected; 4: bold the font; 8: set font color with gcFGSelected; 16: set background image with guSelectedBGImg; - they can be added up to create mixed effects.
