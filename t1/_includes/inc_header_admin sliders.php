...
////////// HTML HEAD
/////////////////////////////////////////////////////////////////////////////////////
include(BASE_DIR . "_includes/inc_head.php");
		...
		<table border=0 width=100% height=100% bordercolor=orange cellpadding=0 cellspacing=0 background='". TEMPLATE_DOMAIN ."bg_header_admin.gif'>
			<tr>
				...
				<td align=center width=33% style='border-left:1px solid gray;border-right:1px solid gray;'>
					<div id='wrapper' style='position:relative;width:100%;height:98px;border:0px solid yellow;'>
						<div id='adminSetup' style='width:100%;height:98px;border:0px solid gray;'>
							...
							."
						</div><div id='adminContacts' style='display:none;width:100%;height:98px;border:0px solid gray;'>
							<!--<img height=30 src='". TEMPLATE_DOMAIN ."_images/icon_arrow_small_down.png' style='position:absolute;left:5px;top:10px;' 
								onclick=\"new Effect.BlindUp('adminContacts',{ afterFinish:Effect.BlindDown('adminSetup') });\">-->
							<h3 style='padding:4px;'>Contacts / People</h3>
							". 
							...
							local_admin_nav(array(
								array(
									url=>"departments.php",
									anchor=>"departments",
									icon=>"_images/icon_contacts.png"),
								array(
									url=>"categories.php",
									anchor=>"categories",
									icon=>"_images/icon_contacts.png"),
								array(
									...
									anchor=>"contacts",
									icon=>"_images/icon_report.png",
									//onclick=>"new Effect.Parallele([new Effect.SwitchOff('adminContacts'),new Effect.SlideDown('adminSetup')]);")
									//onclick=>"new Effect.SlideDown('adminContacts',{ afterFinish:Effect.SlideUp('adminSetup') });")
									onclick=>"new Effect.BlindUp('adminContacts',{ afterFinish:Effect.BlindDown('adminSetup') });")
							))
